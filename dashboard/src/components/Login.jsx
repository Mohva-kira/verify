...
import ntaLogo from "../assets/nta.png"
    ...
    <>
      <div class="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
        <div class="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
          <div class="flex relative items-center justify-center flex-col lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
            <div className="flex absolute top-0 m-5 left-0 w-1/2 ">
            <img src={ntaLogo} class="w-mx-auto md:w-20" />

            </div>
            <div className="flex flex-col w-full justify-center items-center">
              <h1 className="mb-5 mt-10 font-bold text-2xl shadow-sm text-orange-700">Commune Rurale de Siby</h1>
